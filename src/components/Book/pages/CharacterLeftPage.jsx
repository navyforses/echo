...
import './CharacterLeftPage.css';

const CharacterLeftPage = ({ character }) => {
  ...
  return (
    <div className="character-left-content">
      {/* მარცხენა მხარე - მოღვაწის ინფორმაცია */}
      <div className="portrait-section">
        ...
        />
        <h1 className="character-name">{char.name?.ka || char.name}</h1>
        <h2 className="character-title">{char.title?.ka || char.title}</h2>
        <div className="life-dates">{char.birthYear} - {char.deathYear}</div>
      </div>
...
export default CharacterLeftPage; 